 ...
 */
export declare const KNOWN_DEVICE_MAX_AGE_MS: number;
/**
 * Device ids that are (a) not removed and (b) signed in within `maxAgeMs` of
 * `nowMs`. A missing `lastSignedInAt` counts as stale.
 */
export declare function activeDeviceIds(devices: Device[], nowMs: number, maxAgeMs: number): string[];
//# sourceMappingURL=active-devices.d.ts.map