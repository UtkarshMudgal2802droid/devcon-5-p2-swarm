 ...
 */
export declare function makePartitionLockIdentifier(batchId: BatchId, partition: number): Identifier;
/**
 ...
 */
export declare function lockSocAddress(batchId: BatchId, partition: number, owner: EthAddress): Uint8Array;
/**
 ...
 */
export declare function lockSocBucket(batchId: BatchId, partition: number, owner: EthAddress): number;
//# sourceMappingURL=lock-soc.d.ts.map