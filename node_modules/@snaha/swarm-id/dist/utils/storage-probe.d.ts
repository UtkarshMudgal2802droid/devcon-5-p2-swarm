 ...
 */
export declare const STORAGE_SHARED_KEY = "swarm-id-first-party";
/**
 ...
 * must never give.
 */
export declare function markFirstPartyStorage(): void;
/** Whether this context can see the marker a first-party page left. */
export declare function isStorageShared(): boolean;
//# sourceMappingURL=storage-probe.d.ts.map