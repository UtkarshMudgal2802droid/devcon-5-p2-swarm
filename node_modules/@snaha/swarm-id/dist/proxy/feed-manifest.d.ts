 ...
 */
export declare function createFeedManifestDirect(target: UploadTarget, topic: string, owner: string, options?: CreateFeedManifestOptions, uploadOptions?: UploadOptions): Promise<CreateFeedManifestResult>;
