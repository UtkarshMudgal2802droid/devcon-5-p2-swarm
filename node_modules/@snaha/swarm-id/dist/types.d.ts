...
export declare const STORAGE_KEY_LEASE_CACHE_PREFIX = "swarm-id-lease-v2";
/**
 ...
 */
export declare const STORAGE_KEY_PARTITION_SESSION = "swarm-id-partition-session";
/**
 ...
 */
export declare function leaseCacheStorageKey(accountId: string, batchId: string): string;
/**
 ...
 */
export declare function partitionSessionStorageKey(parentOrigin: string): string;
...
export declare const ActPublisherSchema: z.ZodEnum<{
    app: "app";
    identity: "identity";
}>;
...
export declare const ActUploadOptionsSchema: z.ZodOptional<z.ZodObject<{
    ...
    publisher: z.ZodOptional<z.ZodEnum<{
        app: "app";
        identity: "identity";
    }>>;
}, z.core.$strip>>;
...
export declare const DownloadOptionsSchema: z.ZodOptional<z.ZodObject<{
    ...
    actPublisher: z.ZodOptional<z.ZodUnion<readonly [z.ZodCustom<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>, z.ZodString]>>;
    actHistoryAddress: z.ZodOptional<z.ZodUnion<readonly [z.ZodCustom<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>, z.ZodString]>>;
    actTimestamp: z.ZodOptional<z.ZodUnion<readonly [z.ZodNumber, z.ZodString]>>;
}, z.core.$strip>>;
...
export declare const UploadModeSchema: z.ZodEnum<{
 ...
 */
export declare const UploadUnavailableReasonSchema: z.ZodEnum<{
    "no-stamp": "no-stamp";
    "stamper-failed": "stamper-failed";
}>;
export type UploadUnavailableReason = z.infer<typeof UploadUnavailableReasonSchema>;
/**
 ...
 */
export declare const AvatarSourceSchema: z.ZodEnum<{
    generated: "generated";
}>;
...
export declare const ConnectionIdentitySchema: z.ZodObject<{
    ...
    sharingPublicKey: z.ZodOptional<z.ZodString>;
    avatar: z.ZodObject<{
        source: z.ZodEnum<{
            generated: "generated";
        }>;
...
export declare const ConnectionInfoSchema: z.ZodObject<{
    ...
    uploadMode: z.ZodOptional<z.ZodEnum<{
        "user-stamp": "user-stamp";
        subsidised: "subsidised";
        unavailable: "unavailable";
    }>>;
    uploadUnavailableReason: z.ZodOptional<z.ZodEnum<{
        "no-stamp": "no-stamp";
        "stamper-failed": "stamper-failed";
    }>>;
    ...
    appKey: z.ZodOptional<z.ZodObject<{
        address: z.ZodString;
...
export declare const ParentIdentifyMessageSchema: z.ZodObject<{
    ...
    subsidisedGatewayUrl: z.ZodOptional<z.ZodString>;
}, z.core.$strip>;
...
export declare const UploadDataMessageSchema: z.ZodObject<{
    ...
    useWebSocket: z.ZodOptional<z.ZodBoolean>;
    useWorkers: z.ZodOptional<z.ZodBoolean>;
...
export declare const DeriveAppSecretMessageSchema: z.ZodObject<{
    type: z.ZodLiteral<"deriveAppSecret">;
    requestId: z.ZodString;
    label: z.ZodString;
}, z.core.$strip>;
...
export type DeriveAppSecretMessage = z.infer<typeof DeriveAppSecretMessageSchema>;
...
export declare const ProxyReadyMessageSchema: z.ZodObject<{
    ...
    storageShared: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
...
export declare const DeriveAppSecretResponseMessageSchema: z.ZodObject<{
    type: z.ZodLiteral<"deriveAppSecretResponse">;
    requestId: z.ZodString;
    secret: z.ZodCustom<Uint8Array<ArrayBuffer>, Uint8Array<ArrayBuffer>>;
}, z.core.$strip>;
...
export declare const ConnectionInfoChangedMessageSchema: z.ZodObject<{
    type: z.ZodLiteral<"connectionInfoChanged">;
    canUpload: z.ZodBoolean;
    storagePartitioned: z.ZodOptional<z.ZodBoolean>;
    uploadMode: z.ZodOptional<z.ZodEnum<{
        "user-stamp": "user-stamp";
    ...
    uploadUnavailableReason: z.ZodCatch<z.ZodOptional<z.ZodEnum<{
        "no-stamp": "no-stamp";
        "stamper-failed": "stamper-failed";
    }>>>;
    deviceId: z.ZodOptional<z.ZodString>;
...
export type DeriveAppSecretResponseMessage = z.infer<typeof DeriveAppSecretResponseMessageSchema>;
...
export type ConnectionInfoChangedMessage = z.infer<typeof ConnectionInfoChangedMessageSchema>;
...
export declare const AuthDataSchema: z.ZodObject<{
    ...
    account: z.ZodObject<{
        id: z.ZodPipe<z.ZodString, z.ZodTransform<import("@ethersphere/bee-js").EthAddress, string>>;
        name: z.ZodString;
        createdAt: z.ZodNumber;
        derivationKey: z.ZodString;
        publicKey: z.ZodString;
        ...
        connectedApps: z.ZodDefault<z.ZodArray<z.ZodObject<{
            appUrl: z.ZodString;
            appName: z.ZodString;
        ...
        postageStamps: z.ZodDefault<z.ZodArray<z.ZodObject<{
        ...
        partitionCount: z.ZodOptional<z.ZodNumber>;
    }, z.core.$strip>;
}, z.core.$strip>;
 ...
 */
export declare const PartitionSessionSchemaV1: z.ZodObject<{
    version: z.ZodLiteral<1>;
    parentOrigin: z.ZodString;
    connectedUntil: z.ZodNumber;
    data: z.ZodObject<{
        secret: z.ZodString;
        networkSettings: z.ZodOptional<z.ZodObject<{
            beeNodeUrl: z.ZodString;
...
export type { Account, SyncedAccount, ConnectedApp, PostageStamp, } from "./schemas";
