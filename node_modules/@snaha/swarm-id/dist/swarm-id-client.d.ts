...
export declare class SwarmIdClient {
    ...
    private firstConnectionInfoPromise;
    private firstConnectionInfoResolve?;
    private popupMode;
    private metadata;
     ...
     * ```
     */
    deriveAppSecret(label: string): Promise<Uint8Array>;
    /**
